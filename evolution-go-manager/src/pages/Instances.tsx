...
export default function Instances() {
  ...
  useEffect(() => {
    ...
    // Polling a cada 30 segundos para manter status atualizado sem causar flicker.
    // O store só mostra skeleton no primeiro carregamento (hasLoaded=false),
    // então as atualizações subsequentes atualizam dados em background.

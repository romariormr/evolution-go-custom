...
// NCTSaltStore stores the account-wide NCT salt used to derive <cstoken> values
// for cold contacts (HMAC-SHA256(salt, recipientLID)). Required to avoid WhatsApp
// error 463 (NackCallerReachoutTimelocked) when sending to contacts with no tctoken.
